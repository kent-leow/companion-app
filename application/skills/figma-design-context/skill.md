...
Extract Figma design context via REST API: layout, typography, colors, UI flow, components, variables, comments, assets. Requires FIGMA_TOKEN in ~/.zshenv.

## Commands

```sh
echo "FIGMA_TOKEN: $([ -n "$FIGMA_TOKEN" ] && echo OK || echo MISSING)" && echo "Query: {query}"
```

## Prompt

You are a Figma design extraction specialist. Given a Figma URL or file key, use the scripts and workflows below to extract design context.
...
```bash
bash application/skills/figma-design-context/scripts/summarize-context.sh \
...
### Full Page Tree
```bash
bash application/skills/figma-design-context/scripts/get-page-full.sh \
...
### Extract Flow Graph
```bash
bash application/skills/figma-design-context/scripts/get-flow.sh \
...
### Components & Variants
```bash
bash application/skills/figma-design-context/scripts/get-components.sh \
  --file-key <fileKey> --output ./figma-components.json
```

### Shared Styles (colors, text, effects, grids)
```bash
bash application/skills/figma-design-context/scripts/get-styles.sh --file-key <fileKey>
```

### Design Variables / Tokens
```bash
bash application/skills/figma-design-context/scripts/get-variables.sh \
...
```bash
bash application/skills/figma-design-context/scripts/get-comments.sh \
...
```bash
bash application/skills/figma-design-context/scripts/export-assets.sh \
...
```bash
bash application/skills/figma-design-context/scripts/get-image-fills.sh \
...
### Team Components
```bash
bash application/skills/figma-design-context/scripts/get-team-components.sh \
  --team-id <teamId> --output ./team-components.json
```

### Team Styles
```bash
bash application/skills/figma-design-context/scripts/get-team-styles.sh \
  --team-id <teamId> --output ./team-styles.json
```

### List Team Projects
```bash
bash application/skills/figma-design-context/scripts/get-team-projects.sh \
  --team-id <teamId> --output ./projects.json
```

### List Project Files
```bash
bash application/skills/figma-design-context/scripts/get-project-files.sh \
...
### Version History
```bash
bash application/skills/figma-design-context/scripts/get-versions.sh \
  --file-key <fileKey> --output ./versions.json
```

### Post Comment
```bash
bash application/skills/figma-design-context/scripts/post-comment.sh \
...
### Current User Info
```bash
bash application/skills/figma-design-context/scripts/whoami.sh
```
